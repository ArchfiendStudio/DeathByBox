	...
	void Update() {
		if (Input.touchCount == 0) {
			...
			if (oldTouchPositions[0] == null || oldTouchPositions[1] != null) {
				...
				transform.position += transform.TransformDirection((Vector3)((oldTouchPositions[0] - newTouchPosition) * m_OrthographicCamera.orthographicSize / m_OrthographicCamera.pixelHeight * 30f));
